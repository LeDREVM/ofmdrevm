...
- (à créer par Claude pendant l'installation, d'après tes réponses) — qui tu es, ton niveau, ta langue, ton objectif.

---

## 📁 Projet(s) (project)

- (à créer au fil de l'eau) — contexte, contraintes, faits canoniques propres à chaque projet.
  Voir `EXAMPLES/project_EXAMPLE_canonical_facts.md` pour le modèle.
