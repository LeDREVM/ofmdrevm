# [EXEMPLE — règle métier] Content Quality — {{DOMAIN_TOPIC}}
...
| **Donnée canonique fausse** | Une valeur hors des références officielles → {{DOMAIN_CANONICAL_FACT}} |
...
d'affirmer un fait sur {{DOMAIN_TOPIC}} pour {{DOMAIN_AUDIENCE}}.
